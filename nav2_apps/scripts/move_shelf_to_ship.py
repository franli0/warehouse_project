...
class MoveShelfToShip(Node):
    def __init__(self):
        ...
        self.loading_position = {'x': 4.771, 'y': -0.600, 'z': 0.0, 'yaw': -1.648}
        self.shipping_position = {'x': 1.698, 'y': 1.323, 'z': 0.0, 'yaw': 1.570}
        # final_position = {'x': 4.727, 'y': -1.416, 'z': 0.0, 'yaw': -1.600}
    ...
    def get_under_shelf(self):
        ...
        cmd_vel = Twist()
        cmd_vel.linear.x = 0.15  # Forward at 0.15 m/s
    ...
    def get_out_from_shelf(self):
        ...
        cmd_vel = Twist()
        cmd_vel.linear.x = -0.15  # Backward at 0.15 m/s
