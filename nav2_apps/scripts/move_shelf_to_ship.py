...
class MoveShelfToShip(Node):
    def __init__(self):
        ...
        self.init_position = {'x': 0.0, 'y': 0.0, 'theta': 0.0}
        self.loading_position = {'x': 5.6, 'y': -0.7, 'theta': -1.57}
        self.elevator_up_position = {'x': 5.6, 'y': -1.5, 'theta': -1.58}
        self.shipping_position = {'x': 2.4, 'y': 1.5, 'theta': 1.56}
